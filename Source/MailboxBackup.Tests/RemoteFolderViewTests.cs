...
public class RemoteFolderViewTests
{
    ...
    {
        var topLevel = Substitute.For<IRemoteFolder>();
        topLevel.FullName.Returns("");

        var l1 = Substitute.For<IRemoteFolder>();
        l1.FullName.Returns("L1");
        var l2 = Substitute.For<IRemoteFolder>();
        l2.FullName.Returns("L1/L2");
        var l3 = Substitute.For<IRemoteFolder>();
        l3.FullName.Returns("L1/L2/L3");

        l2.Create("L3").Returns(l3);
    ...
    public void CanCreateFolder2()
    {
        ...
        var l3 = Substitute.For<IRemoteFolder>();
        l3.FullName.Returns("L1/L2/L3");
        var l4 = Substitute.For<IRemoteFolder>();
        l4.FullName.Returns("L1/L2/L3");

        l2.Create("L3").Returns(l3);
        l3.Create("L4").Returns(l4);
